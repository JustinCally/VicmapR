...
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{Vicmap for Beginners,eval = all(geoserver_connected, !testthat:::on_cran(), sf::sf_extSoftVersion()[["GDAL"]] > 3)}
  %\VignetteEngine{knitr::rmarkdown,eval = all(geoserver_connected, !testthat:::on_cran(), sf::sf_extSoftVersion()[["GDAL"]] > 3)}
  %\VignetteEncoding{UTF-8,eval = all(geoserver_connected, !testthat:::on_cran(), sf::sf_extSoftVersion()[["GDAL"]] > 3)}
---
...
```{r setup, include=FALSE, echo=FALSE,eval = all(geoserver_connected, !testthat:::on_cran(), sf::sf_extSoftVersion()[["GDAL"]] > 3)}
# LIBRARIES -----
library(VicmapR)
library(sf)
```
