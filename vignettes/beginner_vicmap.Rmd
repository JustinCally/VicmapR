...
mapview(darebin_swoops) + mapview(darebin, alpha.regions = 0.3, col.regions= "purple")
...
mapview(swoops_10k) + mapview(home_radius, alpha.regions = 0.3, col.regions = "purple")
```
